...
+   [ICWSM 数据挑战 (自 2009 年起)](http://icwsm.cs.umbc.edu/)
...
**GitHub 链接：** [`github.com/caesar0301/awesome-public-datasets`](https://github.com/caesar0301/awesome-public-datasets)

![xia-mingXia Ming](http://xiaming.me/pages/about.html) 是 [上海交通大学](http://en.sjtu.edu.cn/) 的博士生。他于 2010 年在 [西电大学](http://en.xidian.edu.cn/)，中国西安，获得了光信息与科学技术学士学位。他的研究领域是移动网络流量的测量与分析，特别是网络流量的更新模型和特性，使用统计和机器学习技术在 [Apache Spark](https://spark.apache.org/) 等分布式处理平台上。
