...
可视化对于任何数据分析师都是至关重要的。当你给利益相关者提供简单的数字时，非专家很难理解其重要性。但一个漂亮的图表或图形？他们就明白了。这就是 [本课程](https://www.coursera.org/learn/visualize-data?specialization=google-data-analytics) 的内容。
