...
> 原文：[`www.kdnuggets.com/2020/05/build-deploy-machine-learning-web-app.html`](https://www.kdnuggets.com/2020/05/build-deploy-machine-learning-web-app.html)

评论

**由 [Moez Ali](https://www.linkedin.com/in/profile-moez/) 贡献，PyCaret 的创始人和作者**

![图示](img/8213893cbe65e0b98f2f494411a5cb55.png)
...
![图示](img/d7e260c18d29b72de9c8083c75ff54ef.png)
...
![图示](img/55da7f0ae496ad44230dae57479ebf11.png)
...
![图](img/77b5d1d13d4a17347dcdb86135860829.png)
...
![图](img/3b081a146b5974e560d42e3bfeb4447f.png)
...
![图示](img/9e478a35206a20e549f19d30a9661636.png)
...
![图示](img/2b54ec5cc7b7325392fccda870773a6d.png)
...
![图示](img/e6172cc6c23d83a4fd3683b3a341b880.png)
...
![图示](img/feb16c63a07224b37ffa90a4a955a984.png)
...
![Figure](img/ca5a8bbb6144dfd4c02bc8262e3aff94.png)
...
![Figure](img/d5073bc26689c4ed2520b3788f1b4bdc.png)
...
![Figure](img/b2daa1c271a42ab84e0dcc83c5b4bb87.png)

[`www.github.com/pycaret/deployment-heroku`](https://www.github.com/pycaret/deployment-heroku)

现在你对上面展示的仓库中的所有文件都很熟悉了，除了两个文件，即 '**requirements.txt**' 和 '**Procfile**'。

![Figure](img/35693d5786a9d88caa018a90432f0d30.png)

requirements.txt

'**requirements.txt**' 文件是一个文本文件，包含执行应用程序所需的 Python 包的名称。如果这些包在应用程序运行的环境中没有安装，应用程序将会失败。

![Figure](img/17ea811b90d8d3bd37482f7e5a324eec.png)
...
![图示](img/aa02c1b6a02bcf867d41f7b46df172b9.png)

Heroku 仪表盘

**步骤 2 — 输入应用程序名称和区域**

![图示](img/701e0be8acd243ba464ee5d7a833a8fd.png)

Heroku — 创建新应用程序

**步骤 3 — 连接到托管代码的 GitHub 仓库**

![图示](img/a494b41066c23b3f6fcaab7eb27b91ca.png)

Heroku — 连接到 GitHub

**步骤 4 — 部署分支**

![图示](img/3470a80faee1fd99b96f7dcbbb6a69e4.png)

Heroku — 部署分支

**步骤 5 — 等待 5–10 分钟，成功**

![图示](img/5f2d87a6bdbbef8693b83f79722b3d93.png)

Heroku — 成功部署

应用程序已发布到网址：[`pycaret-insurance.herokuapp.com/`](https://pycaret-insurance.herokuapp.com/)

![图示](img/e1bde245a86a323e2c9dcd6df0112113.png)

[`pycaret-insurance.herokuapp.com/`](https://pycaret-insurance.herokuapp.com/)
...
![图示](img/9b9346b7d5a4a3870f9877bc5ed6e1f5.png)
...
![图示](img/af12c785bd4cf0f7db433e8b8ce99546.png)
...
我们正在积极改进 PyCaret。未来的发展计划包括一个新的**时间序列预测**模块，与**TensorFlow**的集成，以及 PyCaret 可扩展性的重大改进。如果您想分享反馈并帮助我们进一步改进，可以在网站上[填写此表单](https://www.pycaret.org/feedback)或在我们的[GitHub](https://www.github.com/pycaret/)或[LinkedIn](https://www.linkedin.com/company/pycaret/)页面留言。

**您想要贡献吗？**

PyCaret 是一个开源项目。欢迎大家贡献。如果您想贡献，请随时处理[开放问题](https://github.com/pycaret/pycaret/issues)。我们接受带有单元测试的开发分支上的拉取请求。
...
**个人简介: [Moez Ali](https://www.linkedin.com/in/profile-moez/)** 是数据科学家，也是 PyCaret 的创始人和作者。
