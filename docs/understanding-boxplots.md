...
> 原文：[`www.kdnuggets.com/2019/11/understanding-boxplots.html`](https://www.kdnuggets.com/2019/11/understanding-boxplots.html)

评论

**由 [Michael Galarnyk](https://www.linkedin.com/in/michaelgalarnyk/)，数据科学家**

![图示](img/47112087370820577dde8c44d5592839.png)
...
![图示](img/c06e4a4d70f8b04400847dae5dc97c96.png)
...
![图示](img/d4dcf99a1f745f7668a16694db8fd8ff.png)
...
这部分内容与[68–95–99.7 规则文章](https://towardsdatascience.com/understanding-the-68-95-99-7-rule-for-a-normal-distribution-b7b7cbf760c2)非常相似，但经过了针对箱线图的调整。为了理解这些百分比的来源，了解概率密度函数（PDF）是很重要的。PDF 用于指定随机变量在*特定范围内*的概率，而不是取任何一个值。这种概率由该变量的 PDF 在该范围内的积分给出——即由密度函数下方、水平轴上方以及范围内的最低值和最大值之间的面积给出。这个定义可能不太容易理解，让我们通过绘制正态分布的概率密度函数来澄清这一点。下面的方程是正态分布的概率密度函数。

![图示](img/09eeca96a87d12120e91f7cc9e1ddabd.png)

正态分布的 PDF

我们通过假设均值（μ）为 0，标准差（σ）为 1 来简化这个问题。

![图示](img/3b472349b88842f047b49f1be317e1de.png)
...
![](img/e3dfb136ebe88de0c72380c26ad23b06.png)
...
![图示](img/e4638042ef4598e841d94a6af2249fe1.png)
...
![](img/fe651816b3ea0fd6286da10fac9b713b.png)

如前所述，异常值占数据的剩余 0.7%。

需要注意的是，对于任何 PDF，曲线下的面积必须为 1（从函数的范围内绘制任何数字的概率始终为 1）。

![](img/1568441562294a441f29ac55e7c98f0f.png)
...
![](img/a99940d31fbd36c8c56d13b5abe3206e.png)
...
![图示](img/d62c0379fccfc8185ddb90e71a1b3562.png)
...
![](img/fcc94f79b65927e164818a3330f428f3.png)
...
![图像](img/09cf8854a17d6a05fa8e65de9c304d99.png)
...
![](img/e0786f7f6c4560be8d441ec508f2687c.png)
