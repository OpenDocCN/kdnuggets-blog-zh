...
> 原文：[`www.kdnuggets.com/2019/06/whole-data-science-world.html`](https://www.kdnuggets.com/2019/06/whole-data-science-world.html)

![c](img/3d9c022da2d331bb56691a9617b91b90.png) 评论![figure-name](img/124fbbe27a6626e955118b663fb58934.png) 图片由 [Héizel Vázquez](https://www.instagram.com/heizelvazquez/) 提供
...
![figure-name](img/c23609b8c1b38049b9689cd99bba511f.png)
...
![figure-name](img/26f3f594f5c0603949bf672c40a1bdc7.png)

**Jupyter Notebook**

![figure-name](img/eb09fc8fe528394284a73a26854d6fff.png)

我目前最喜欢的编程语言是 Python。使用这种语言有很多很棒的工具和功能。其中一个最受欢迎的工具是 Jupyter Notebook。要在 MatrixDS 中启动笔记本，请执行以下操作：

1.  转到平台中的工具标签。

1.  点击右侧的 (+) 按钮：![figure-name](img/bfbea8f1ae71ad5db97edf36feee0e15.png)

1.  选择 Python 3（或 2）与 Jupyter Notebook：![figure-name](img/63bfa44dfec09ed801a783e2cd77072f.png)

1.  为工具选择一个名称，并设置核心数和内存：![figure-name](img/4de431b16b73cfb6adf66c2b1c50fe76.png)

1.  当笔记本创建并启动后，只需打开它：![figure-name](img/9f3ad0e1d54462d57aa957f9154dbaee.png)
...
![图像名称](img/16447d685a5d091d29b9d9bacb59a72a.png)
...
1.  点击右侧的 (+) 按钮：![图像名称](img/bfbea8f1ae71ad5db97edf36feee0e15.png)

1.  选择 Python 3 和 JupyterLab：![图像名称](img/a76e4f48c94a5a2b4feb0a6d00bbe910.png)

1.  选择工具的名称并设置核心数和内存：![图像名称](img/f550410121c01d2abafb2941a68a9615.png)

1.  当工具创建并启动后，只需打开它：![图像名称](img/9c30e5634b6fd21f22f2f1750f6c8a5c.png)
...
1.  更加有趣 :)
    ...
    ![图像名称](img/f4a5f331a0f58e5be3fdd1b314c09f8b.png)
...
![figure-name](img/ef2dd0eaa7f9abb24fd6474fcd1fdaf1.png)[`www.computerworld.com/video/series/8563/do-more-with-r`](https://www.computerworld.com/video/series/8563/do-more-with-r)
...
1.  选择 R 3.5 和 RStudio:![figure-name](img/a4a0d491b7decca75f6bf4fb7d960319.png)

1.  为工具选择一个名称，并设置核心数量和内存：![figure-name](img/2d4ea944a81dedb03ce6158bb9f84c9e.png)

1.  当工具创建并启动后，只需打开它：![figure-name](img/10d0dac8ea30fa6bab43bf3c9f6907a1.png)
...
![figure-name](img/43d648544f38efdd2cf0ab32ca70b52a.png)
...
![figure-name](img/f66d4e76653367b5f18e41ae2f092254.png)
...
![figure-name](img/d9945fe57315407821bfde0f1f0722e1.png)
...
1.  为工具选择一个名称，并设置核心数量和内存：![figure-name](img/6e4f862cd4d48b6294227f40173594cc.png)

1.  当工具创建并启动后，只需打开它：![figure-name](img/c99e4e9eb294546b265246c7301192a5.png)

1.  让我们用 Julia :) （听起来有点奇怪）

    启动时，你可以打开或创建任何 Python 或 Julia 笔记本：![figure-name](img/c54fe1aeb7cabb60651cea912b025655.png)
