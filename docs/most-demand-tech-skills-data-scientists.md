...
最显著的 **深度学习框架** 变得越来越受欢迎。 **PyTorch** 是所有关键词中增长百分比最大的一项。 **Keras** 和 **TensorFlow** 也有了大幅度的增长。Keras和PyTorch在排名中分别上升了四位，TensorFlow上升了三位。需要注意的是，PyTorch的起始平均值较低——TensorFlow的平均值仍然是PyTorch的两倍。
