...
![](img/935fd87bb21b2d7076aaa36908b7c53a.png)
...
Pandas 是一个非常流行的数据处理库，而且使用非常广泛。它非常重要且**成熟**的一个函数是*read_csv()*，它可以非常容易地读取任何**.csv**文件，并帮助我们处理它。让我们在我们的 100-Sales-Record 数据集上做这个。
