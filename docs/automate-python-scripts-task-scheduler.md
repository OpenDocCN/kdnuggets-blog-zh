...
> 原文：[`www.kdnuggets.com/2019/09/automate-python-scripts-task-scheduler.html`](https://www.kdnuggets.com/2019/09/automate-python-scripts-task-scheduler.html)

评论

**由 [Vincent Tatan](https://www.linkedin.com/in/vincenttatan/)，Google 的数据分析师（机器学习）、信任与安全部门**

![figure-name](img/011bf2ba444bc813041c2d9c323d59ed.png) 图片来源：Stocksnap
...
![figure-name](img/c206897f159556fc3e3a5443ed948201.png) 使用任务计划程序运行网络抓取脚本，然后将其附加到 SQLite 磁盘
...
![figure-name](img/29d90cae1703795d1b33dd8e308d7e29.png)任务调度程序自动化应用程序网页抓取的流程
...
![figure-name](img/c206897f159556fc3e3a5443ed948201.png)运行 Web 抓取脚本与任务调度器，然后将其追加到 SQLite 磁盘！![figure-name](img/1691bc308af0f91bbb96dc82603c4c8f.png)通过任务调度器将数据追加到 SQLite

### 最后…

![figure-name](img/97bc8f472fefd32b6a860325a8e7550a.png)男孩在读书时笑了，来源：Unsplash
...
**简介：[Vincent Tatan](https://www.linkedin.com/in/vincenttatan/)** 目前是 Google 的信任与安全数据分析师（机器学习）。他对数据和技术充满热情，拥有来自 Visa Inc.和 Lazada 的相关工作经验，实施微服务架构、商业智能和分析管道项目。
