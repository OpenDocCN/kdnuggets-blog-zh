...
1.  [JT 论决策管理](http://jtonedm.com/)，由**詹姆斯·泰勒**撰写，涉及决策管理的一切。
...
1.  ![new 数据领域的冒险](http://blog.smola.org/)，由 Alex Smola 撰写。
...
1.  ![new 数据科学博客](https://github.com/rushter/data-science-blogs)，一个精心策划的数据科学博客列表。
