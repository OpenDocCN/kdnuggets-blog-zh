...
![](img/0bbe00ce8758bbf6eefe83ed77c3be39.png)

应该会出现一个类似于下面的页面。

![图示](img/e3b1617cbcb247869432a20d8e52847a.png)
...
**服务条款网址：** 我放入了 Fitbit 的服务条款：[`dev.fitbit.com/legal/platform-terms-of-service/`](https://dev.fitbit.com/legal/platform-terms-of-service/)

**隐私政策网址：** 我放入了 Fitbit 的隐私政策：[`www.fitbit.com/legal/privacy-policy`](https://www.fitbit.com/legal/privacy-policy)
...
![](img/88b7255a6602ccaa74594331dbd1cfde.png)

最后，点击同意框，然后点击注册。应该会出现一个类似下面的页面。

![图示](img/1dec7c838f6608b801d0e68f30d8bd9a.png)
...
![图示](img/b27d3483e359adf3a208a3eda835db44.png)
...
![图示](img/3c7410fca134baea83e97bb3a150543c.png)
...
![图示](img/59c899dd7d69bc7cb6e9df48ee4224cd.png)

当你运行上面的代码（如 A 所示）时，单元格会显示仍在运行，直到你登录到你的 Fitbit 账户（B）并点击允许访问 Fitbit 账户中的各种数据。

授权和登录后页面的样子。

![图示](img/5c90e42e48789052e7e68f7e56f89919.png)

这个窗口应该是你看到的内容。

### 5a.) 获取一天的数据

![图示](img/8a5e2cc1320e007ab0f7f1389c75f171.png)
...
![](img/0ab5ac3a7c0d5d3e353f99d6b018227c.png)

如果你愿意，可以将这些数据放入 pandas DataFrame 中。

![](img/fc830e186c1aaa38469dc75dd9c07c75.png)
...
![](img/d00c0b640b562d6534adeaf24734853a.png)
...
有研究讨论了[静息心率](https://www.health.harvard.edu/blog/resting-heart-rate-can-reflect-current-future-health-201606179806)如何反映你的当前和未来健康。实际上，有一篇[研究论文展示了 92,447 名佩戴 Fitbit 的成年人在静息心率的个体间和个体内变异性及其与年龄、性别、睡眠、BMI 和季节的关联](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0227709)。以下是论文中的一张图片（添加了文本以便于理解）。

![图示](img/12cb0f35adee20ec48a85dceef1e0e44.png)

[`journals.plos.org/plosone/article?id=10.1371/journal.pone.0227709`](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0227709)
...
![](img/71f6dc17a055457e70f677b78f7118ab.png)
...
![](img/6467ac8a0b6929fd531a3e3f0f2acab4.png)

### Https 与 Http 错误

以下错误发生在我尝试将回调 URL 更改为 https 而不是 http 的第二步中。

![](img/d750a43c28d005aa71e09049810e9e5a.png)

### HTTPTooManyRequests: 请求过多

![](img/c36f10826d885e3e28d287ee84b9f209.png)
